...
//     $bukus = Buku::all();
//     foreach ($bukus as $buku) {
//         $html .= $buku->judul . ' - ' . $buku->status_stok_badge . '<br>';
//     }

//     $html .= '<h2>Buku Terbaru</h2>';
//     $terbaru = Buku::terbaru()->get();
//     foreach ($terbaru as $buku) {
//         $html .= $buku->judul . ' (' . $buku->tahun_label . ')<br>';
//     }
...
//     $anggotas = Anggota::all();
//     foreach ($anggotas as $anggota) {
//         $html .= $anggota->nama . ' - ' . $anggota->status_badge . '<br>';
//     }

//     $html .= '<h2>Kategori Usia</h2>';
//     foreach ($anggotas as $anggota) {
//         $html .= $anggota->nama . ' - ' . $anggota->kategori_usia . '<br>';
//     }
